<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Master.Master" AutoEventWireup="true" CodeBehind="UpdateCart.aspx.cs" Inherits="TokoBeDia.Views.UpdateCart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <form runat="server">
            ...
            <asp:Label runat="server" Text="Label" ID="Label2"></asp:Label><br />
            ...
            <asp:TextBox ID="TxtQty" runat="server" TextMode="Number" Text=""></asp:TextBox><br />
