<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Master.Master" AutoEventWireup="true" CodeBehind="ViewProduct.aspx.cs" Inherits="TokoBeDia.Views.ViewProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="m-5" style="text-align: center; align-content: center">
        ...
        <form runat="server">
            ...
            <asp:GridView ID="GvViewProduct" CssClass="ml-auto mr-auto table" runat="server" AutoGenerateColumns="False" OnRowDeleting="GvViewProduct_RowDeleting" OnRowUpdating="GvViewProduct_RowUpdating" OnRowCreated="GvViewProduct_RowCreated" OnRowCommand="GvViewProduct_RowCommand" >
                <Columns>
